...
export type InferResponse<T> = T extends Endpoint<infer R, any, any> ? z.infer<R> : never;
...
export type ExtractPath<T extends string> = T extends `${HttpMethod} ${infer P}` ? P : never;
